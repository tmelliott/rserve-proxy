...
function createMockMetricsDb(): MetricsDb & { calls: Record<string, unknown[][]> } {
  ...
  return {
    ...
    insertStatusPoints: vi.fn().mockResolvedValue(undefined),
    queryAppMetrics: vi.fn().mockResolvedValue([]),
    queryAllAppMetrics: vi.fn().mockResolvedValue([]),
    querySystemMetrics: vi.fn().mockResolvedValue([]),
    queryStatusPoints: vi.fn().mockResolvedValue([]),
    queryAppStatusPoints: vi.fn().mockResolvedValue([]),
